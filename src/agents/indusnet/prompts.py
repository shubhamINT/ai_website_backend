...
Available_tool_20:
  ...
  description: "Internet data retrieval tool via SearXNG. Use this when KB search is not useful/relevant for the user's question or when broader/latest web context is needed. This tool retrieves text snippets for synthesis and does NOT update the user's screen."
